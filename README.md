...
1. Install Ruby matching the profile you'll run (3.2.x for `8-*` profiles, >= 3.4 for `9-*` profiles — see `profiles/puppet_profiles.json`'s `ruby_version` field) and Bundler.
2. From repo root:
