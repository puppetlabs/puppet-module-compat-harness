...
| [puppet-puppetserver](https://github.com/voxpupuli/puppet-puppetserver) | Archived | 2026-06-22 | Archived by Vox Pupuli; moved to [theforman/puppet-puppet](https://github.com/theforman/puppet-puppet) | [theforman/puppet-puppet](https://github.com/theforman/puppet-puppet) | Repository is read-only. `metadata.json` caps Puppet support at `< 6.0.0`; unit tests also fail due to legacy `git://` fixture URLs that no longer resolve. |
